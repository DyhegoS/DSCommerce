...
public class UserFactory {
	...
	public static User createStockUser() {
		User user = new User(3L, "estoque", "estoque@gmail.com", "$2a$10$N7SkKCa3r17ga.i.dF9iy.BFUBL2n3b6Z1CWSZWi/qy7ABq/E6VpO");
		user.addRole(new Role(1L, "ROLE_STOCK_USER"));		
		return user;
	}
	
	public static User createAdminUser() {
		User user = new User(1L, "admin", "admin@gmail.com", "$2a$10$N7SkKCa3r17ga.i.dF9iy.BFUBL2n3b6Z1CWSZWi/qy7ABq/E6VpO");
